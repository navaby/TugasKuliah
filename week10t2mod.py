...
button_save = tk.Button(frame, text="SAVE", command=save_action, width=10, bg="#4d4d4d", fg="white")
button_save.grid(row=3, column=0, pady=10)

button_update = tk.Button(frame, text="UPDATE", command=update_action, width=10, bg="#4d4d4d", fg="white")
button_update.grid(row=3, column=1, pady=10, sticky="w")

button_delete = tk.Button(frame, text="DELETE", command=delete_action, width=10, bg="#4d4d4d", fg="white")
button_delete.grid(row=3, column=1, pady=10, sticky="e")

text_output = tk.Text(frame, width=40, height=5, bg="black", fg="white")
